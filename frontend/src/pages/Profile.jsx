    ...
    <div>
        ...
        <div className="px-8 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse md:items-start items-start">
            ...
            <div className="flex flex-col space-y-4 items-start">
                ...
                <input onChange={(e)=>setUsername(e.target.value)} value={username} clasName="outline-none px-4 py-2 text-gray-500" placeholder="Your username" type="text" />
                <input onChange={(e)=>setEmail(e.target.value)} value={email} className="outine-none px-4 py-2 text-gray-500" placeholder="Your email" type="email" />
